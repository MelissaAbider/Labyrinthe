...
public class Lire {
    ...
    public static String S(String... domaine) {
        ...
        do {
            ...
            if (!valide)
                System.out.println(proposition + " n'appartient pas à " + liste);
    ...
    private static String messageErreurGauche(double essai, boolean ouvertGauche, double borneMin) {
        String erreur = "";
        if (essai < borneMin)
            erreur = essai + " < borne min.";
        else if (ouvertGauche && essai == borneMin)
            erreur = "intervalle ouvert, or " + essai + " = borne min.";
    ...
    private static String messageErreurDroite(double essai, double borneMax, boolean ouvertDroite) {
        String erreur = "";
        if (essai > borneMax)
            erreur = essai + " > borne max.";
        else if (ouvertDroite && essai == borneMax)
            erreur = "intervalle ouvert, or " + essai + " = borne max.";
    ...
    public static double d(boolean ouvertGauche, double borneMin, double borneMax, boolean ouvertDroite) {
        ...
        do {
            ...
            if (ouvertGauche)
                ...
                partieGauche = "[";
            if (borneMin == Double.NEGATIVE_INFINITY)
                partieGauche = partieGauche + "-∞";
            else
                partieGauche = partieGauche + borneMin;
            String partieDroite = "";
            if (borneMax == Double.POSITIVE_INFINITY)
                partieDroite = "∞";
            else
                partieDroite = partieDroite + borneMax;
            if (ouvertDroite)
